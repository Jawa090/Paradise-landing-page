  ...
  return (
    <header className="site-header">
      <div className="container header-inner">
        ...
        >
          <img src="/logo.webp" alt="Paradise Estimating Logo" className="brand-logo-img" width="68" height="68" />
        </a>
        ...
        <div className="header-right">
          <a href="tel:7187196171" className="header-call" data-track-cta="header-phone">
            ...
            <div className="header-phone-info">
              <span className="header-phone-label">Direct Estimating Desk</span>
